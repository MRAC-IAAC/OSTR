...
camera_image_width = 1920 # Or get this from opencv camera input
...
def thresh_callback(val):
    ...
    for contour in contours:
        ...
        for i in range(len(contour)):
            ...
            angle = find_angle(current_point, target_point, point_after_target)
            distance = find_distance(current_point, target_point)*distance_to_pixel_ratio
